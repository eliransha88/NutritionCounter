...
/// Since NutritionCore is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "NutritionCounter_NutritionCore"
    ...
    fatalError("unable to find bundle named NutritionCounter_NutritionCore")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class NutritionCoreResources: NSObject {
