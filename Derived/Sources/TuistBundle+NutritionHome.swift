...
/// Since NutritionHome is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "NutritionCounter_NutritionHome"
    ...
    fatalError("unable to find bundle named NutritionCounter_NutritionHome")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class NutritionHomeResources: NSObject {
