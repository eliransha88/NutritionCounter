...
/// Since NutritionUI is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "NutritionCounter_NutritionUI"
    ...
    fatalError("unable to find bundle named NutritionCounter_NutritionUI")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class NutritionUIResources: NSObject {
